...
const App: React.FC = () => {
  ...
  // Lifted state for calculators to share data with the Material List tab
            ...
            <div className="space-y-6">
              <div className="p-6 bg-slate-800/50 rounded-3xl border border-yellow-500/20 space-y-4">
                ...
                <p className="text-slate-400 text-xs leading-relaxed font-medium">
                  To use this offline and with a high-contrast full-screen interface, follow these steps on your mobile device:
                </p>
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-1">
                      <p className="text-xs font-bold text-slate-200 uppercase">Open in Browser</p>
                      <p className="text-[11px] text-slate-500 font-medium">Open your permanent link in Safari (iOS) or Chrome (Android).</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-1">
                      <p className="text-xs font-bold text-slate-200 uppercase">Tap Browser Menu</p>
                      <p className="text-[11px] text-slate-500 font-medium">Tap the <span className="text-white font-bold italic">Share</span> button (iOS) or the <span className="text-white font-bold italic">Three Dots</span> (Android).</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <span className="bg-yellow-500 text-slate-950 w-6 h-6 rounded-full flex items-center justify-center font-black text-[10px] shrink-0">3</span>
                    <div className="space-y-1">
                      <p className="text-xs font-bold text-yellow-500 uppercase italic">Add to Home Screen</p>
                      <p className="text-[11px] text-slate-500 font-medium">Select <span className="text-yellow-500 font-bold underline italic">Add to Home Screen</span>. Look for the "J" icon on your phone.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mt-1 ml-0.5 italic">Field Tool v5.0</span>
              </div>
            </div>
            ...
            <div className="flex gap-2">
              <button 
                ...
                className="p-3 bg-slate-900 text-slate-400 rounded-2xl border border-slate-800 active:scale-90 transition-all hover:text-white group"
